...
const Registration = () => {
  return (
    <div className='w-full flex flex-row'>
      <div className='w-1/2 flex flex-col gap-y-8 pt-10 items-center'>
        <p className='text-yellow text-[40px] font-black'>EvenTracking</p>
        <h1 className='text-gray-black text-6xl font-bold'>Register</h1>
        <input type="text" placeholder='Name , Last Name' className='outline-none bg-input rounded-lg w-[628px] h-[80px] pl-5 text-base font-bold placeholder: text-loginplaceholder'/>
        ...
        <p className='text-gray-black text-base font-bold'>Already have account ?</p>
        <p className='text-yellow text-base font-bold'>Register</p>
      </div>
